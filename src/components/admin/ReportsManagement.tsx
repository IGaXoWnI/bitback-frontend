...
function ReportsManagement() {
  const [reports, setReports] = useState([
    { 
      ...
      description: 'Compilation of user reported bugs and issues',
      category: 'User', 
      status: 'Open', 
      priority: 'High',
      created: '2025-04-12',
    ...
    { 
      id: 2, 
      title: 'Merchant Verification Report', 
      description: 'Monthly merchant verification status',
      category: 'Merchant', 
      status: 'In Progress', 
      priority: 'Medium',
      created: '2025-04-10',
    ...
    { 
      ...
      description: 'Analysis of payment processing errors',
      category: 'System', 
      status: 'Resolved', 
      priority: 'High',
      created: '2025-04-02',
    ...
    { 
      ...
      description: 'Review of flagged content and actions taken',
      category: 'Content', 
      status: 'In Progress', 
      priority: 'Low',
      created: '2025-04-08',
      ...
      <div className="sm:flex sm:items-center sm:justify-between mb-8">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600">
            View and manage system reports and issue tracking
          </p>
        </div>
        <button
          type="button"
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">1</span> to <span className="font-medium">5</span> of <span className="font-medium">5</span> reports
                </p>
              </div>
              <div>
